...
var ChartSvg = (function(_Component) {
  ...
  function ChartSvg(props) {
    ...
    return _possibleConstructorReturn(
      this,
      Object.getPrototypeOf(ChartSvg).call(this, props)
    );
  }
  ...
  _createClass(ChartSvg, [
    {
      ...
      value: function render() {
        ...
        var xDomain =
          xDomain ||
          (0, _reactD3Core.xDomainCount)(this.props, stack, horizontal);
        var yDomain =
          yDomain ||
          (0, _reactD3Core.yDomainCount)(this.props, stack, horizontal);
        ...
        var children = _react2.default.Children.map(
          this.props.children,
          function(el) {
            if (el) {
