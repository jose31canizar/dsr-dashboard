...
var Axis = (function(_Component) {
  ...
  function Axis(props) {
    ...
    return _possibleConstructorReturn(
      this,
      Object.getPrototypeOf(Axis).call(this, props)
    );
  }
  ...
  _createClass(Axis, [
    ...
    },
    {
      ...
      value: function _mkScale() {
        ...
        if (this.props.scale === "ordinal") newScale = "band";
        else newScale = this.props.scale;

        var func = (0, _scale.scale)(
          Object.assign({}, this.props, { scale: newScale })
        );
    ...
    },
    {
      ...
      value: function render() {
        ...
        if (type === "x") var axisClasses = axisClassName + " axis x";
        else if (type === "y") var axisClasses = axisClassName + " axis y";
